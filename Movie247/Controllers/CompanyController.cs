...
namespace Movie247.Controllers
{
    public class CompanyController : Controller
    {
        ...
        public CompanyController(MOVIEPROJECTContext context)
        {
            _context = context;
        }
        ...
        public IActionResult Index()
        {
            ...
            List<ProductionCompany> productionCompanies = companyLogic.GetAllCompanies();
        ...
        public IActionResult Details(int? id)
        {
            ...
            var productionCompany = companyLogic.GetCompanyById(id ?? 0);
